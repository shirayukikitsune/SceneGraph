...
std::shared_ptr<Node> Node::addChildNode() {
    std::shared_ptr<Node> CurrentNode(new Node(ParentScene));
...
void Node::setLocalOffset(const glm::vec3 &offset) {
    LocalOffset = offset;
    LocalTransform =
            glm::translate(glm::mat4(1.0f), LocalOffset) * glm::toMat4(LocalRotation) * glm::scale(glm::mat4(1.0f), LocalScale);
    invalidate();
}
...
Node::invalidatedByParentCallback::auto_remover_type
Node::addInvalidatedByParentEvent(invalidatedByParentCallback::function_type &&function) {
    return invalidatedByParentEvent.push_auto(function);
}

Node::invalidatedByParentCallback::auto_remover_type
Node::addInvalidatedByParentEvent(const invalidatedByParentCallback::function_type &function) {
    return invalidatedByParentEvent.push_auto(function);
}

Node::componentChangedCallback::auto_remover_type
Node::addComponentAddedEvent(componentChangedCallback::function_type &&function) {
    return componentAddedEvent.push_auto(function);
}

Node::componentChangedCallback::auto_remover_type
Node::addComponentAddedEvent(const componentChangedCallback::function_type &function) {
    return componentAddedEvent.push_auto(function);
}

Node::componentChangedCallback::auto_remover_type
Node::addComponentRemovedEvent(componentChangedCallback::function_type &&function) {
    return componentRemovedEvent.push_auto(function);
}

Node::componentChangedCallback::auto_remover_type
Node::addComponentRemovedEvent(const componentChangedCallback::function_type &function) {
    return componentRemovedEvent.push_auto(function);
}
