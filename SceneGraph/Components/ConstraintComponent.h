...
namespace kitsune::scenegraph {
    ...
    public:
        ...
        void setLowerAngularLimit(const btVector3 &LowerAngularLimit) {
            setConstraintLimits();
            this->LowerAngularLimit = LowerAngularLimit;
        }

        const btVector3 &getLowerAngularLimit() const { return this->LowerAngularLimit; }

        void setLowerLinearLimit(const btVector3 &LowerLinearLimit) {
            setConstraintLimits();
            this->LowerLinearLimit = LowerLinearLimit;
        }
        ...
        void setUpperAngularLimit(const btVector3 &UpperAngularLimit) {
            setConstraintLimits();
            this->UpperAngularLimit = UpperAngularLimit;
        }

        const btVector3 &getUpperAngularLimit() const { return this->UpperAngularLimit; }

        void setUpperLinearLimit(const btVector3 &UpperLinearLimit) {
            setConstraintLimits();
            this->UpperLinearLimit = UpperLinearLimit;
        }
